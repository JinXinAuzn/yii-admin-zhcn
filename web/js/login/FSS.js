function FSS(container, output) {
    ...
    (function () {
        for (var b = 0, d = ["ms", "moz", "webkit", "o"], h = 0; h < d.length && !window.requestAnimationFrame; ++h)
            window.requestAnimationFrame = window[d[h] + "RequestAnimationFrame"],
    ...
    FSS.Plane = function (b, d, h, g) {
        ...
        for (b = 0; b <= this.segments; b++)
            for (h.push([]), d = 0; d <= this.slices; d++)
                g = new FSS.Vertex(l + b * this.segmentWidth, n - d * this.sliceHeight),
                        h[b].push(g),
    ...
    /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ||
            function () {
                ...
                (function () {
                    ...
                    D.clear();
                    for (b = 0; b < n.count; b++)
                        d = new FSS.Light(n.ambient, n.diffuse),
